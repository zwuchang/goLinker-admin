...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		// 定时任务管理相关API
		{ApiGroup: "定时任务管理", Method: "POST", Path: "/cron/list", Description: "获取定时任务列表"},
		{ApiGroup: "定时任务管理", Method: "POST", Path: "/cron/update", Description: "更新定时任务"},
		{ApiGroup: "定时任务管理", Method: "POST", Path: "/cron/stop", Description: "暂停定时任务"},
		{ApiGroup: "定时任务管理", Method: "POST", Path: "/cron/start", Description: "启动定时任务"},
