...
import (
	...
	"goLinker-admin/server/core/internal"
...
func Viper() *viper.Viper {
	...
	// 统一设置代理
	if global.GVA_CONFIG.System.HTTPProxy != "" {
		fmt.Println("设置代理", global.GVA_CONFIG.System.HTTPProxy)
		os.Setenv("HTTP_PROXY", global.GVA_CONFIG.System.HTTPProxy)
		os.Setenv("HTTPS_PROXY", global.GVA_CONFIG.System.HTTPProxy)
	}
